...
MODEL_METADATA = {
    ...
    "day-extractor-8b-q4": {
        ...
        "port": 8082,
        "mode": "day",
        "model_name": "day-extractor-8b-q4",
        "ctx": 2048,
        "threads": 2,
        "threads_batch": 2,
        "parallel": 1,
    ...
    "day-extractor-8b-q4-b": {
        ...
        "port": 8083,
        "mode": "day",
        "model_name": "day-extractor-8b-q4-b",
        "ctx": 2048,
        "threads": 2,
        "threads_batch": 2,
        "parallel": 1,
    ...
    "day-extractor-4b-q8": {
        "file": "Qwen3-4B-Instruct-Q8_0.gguf",
        "size": "4.0GB",
        "port": 8082,
        "mode": "day",
        "model_name": "day-extractor-4b-q8",
        "ctx": 2048,
        "threads": 2,
        "threads_batch": 2,
        "parallel": 1,
    ...
    "day-extractor-4b-q8-b": {
        ...
        "port": 8083,
        "mode": "day",
        "model_name": "day-extractor-4b-q8-b",
        "ctx": 2048,
        "threads": 2,
        "threads_batch": 2,
        "parallel": 1,
...
DAY_PHASE_MODELS = {
    ...
    "day_enrich_b": "day-enricher-b",
    "day_verify": "day-verifier",
    "day_verify_b": "day-verifier-b",
    "day_verify_q8": "day-verifier-q8",
    "day_verify_q8_b": "day-verifier-q8-b",
    "day_verify_q4": "day-verifier-q4",
    "day_verify_q4_b": "day-verifier-q4-b",
}
